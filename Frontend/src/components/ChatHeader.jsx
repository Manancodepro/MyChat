...
const ChatHeader = ({ onBack }) => {
  ...
  return (
    <div className="px-2 sm:px-4 py-2 border-b border-base-300 bg-base-100">
      <div className="flex items-center justify-between gap-1 sm:gap-2 h-12 sm:h-14">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-1">
          ...
          {/* Avatar */}
          <div className="avatar flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10">
        ...
        <div className="flex items-center gap-0.5 sm:gap-1 flex-shrink-0">
          ...
          <div className="hidden sm:block relative">
            <button
              ...
              className="p-1.5 hover:bg-base-200 rounded transition"
              title="Send emoji"
            >
              <Smile size={18} />
            </button>
            ...
            {/* Emoji Picker */}
            {showEmojiPicker && (
              <div className="absolute -right-1 top-12 bg-slate-800 border border-slate-700 rounded-lg shadow-2xl p-2 z-50 w-56 max-h-60 overflow-y-auto">
                {/* Quick Emojis */}
                <div className="mb-2">
